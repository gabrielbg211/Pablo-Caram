    ...
    <div class="wrapper">
        ...
        <div class="d-menu">
            ...
            <div class="search-container">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-search search-icon" width="24" height="24" viewBox="0 0 24 24" stroke-width="1.5" stroke="#000000" fill="none" stroke-linecap="round" stroke-linejoin="round" onclick="search()">
